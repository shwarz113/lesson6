...
open_btn.addEventListener('click', () => {
	...
	open_btn.textContent = 'Магазин открыт!';
});
...
hire_employers_item[0].addEventListener('keyup', () => {
	hire_employers_item[0].value = hire_employers_item[0].value.replace(/[^а-яА-Я\s]+/g,'');
});
hire_employers_item[1].addEventListener('keyup', () => {
	hire_employers_item[1].value = hire_employers_item[1].value.replace(/[^а-яА-Я\s]+/g,'');
});
hire_employers_item[2].addEventListener('keyup', () => {
	hire_employers_item[2].value = hire_employers_item[2].value.replace(/[^а-яА-Я\s]+/g,'');
});
